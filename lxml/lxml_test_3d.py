...
gpx_segment = [Trackpt(
    ...
    elevation=float(x.findall('ele', namespaces=NSMAP)[0].text), 
    ) 
    for x in trkpts]

rm_trkpts = reduce_points_3d.reduce_points3d(gpx_segment, target_points=points, flags_out=True)
